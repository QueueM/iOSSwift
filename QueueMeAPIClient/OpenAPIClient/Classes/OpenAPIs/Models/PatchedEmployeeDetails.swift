...
public struct PatchedEmployeeDetails: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int? = nil, workingHours: [EmployeeWorkingHours]? = nil, roles: [String: AnyCodable]? = nil, name: String? = nil, position: String? = nil, salary: Double? = nil, aiPerformanceData: AnyCodable? = nil, createdAt: Date? = nil, user: Int? = nil, company: Int? = nil, shop: Int? = nil) {
        self.id = id
...
extension PatchedEmployeeDetails: Identifiable {}
