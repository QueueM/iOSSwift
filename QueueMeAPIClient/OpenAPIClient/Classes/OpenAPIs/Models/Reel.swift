...
public struct Reel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, shop: Int, video: String, videoUrl: String, thumbnail: String? = nil, thumbnailUrl: String, caption: String? = nil, createdAt: Date, likeCount: Int, viewCount: Int64? = nil, shareCount: Int64? = nil, saveCount: Int64? = nil, aiVideoTags: AnyCodable? = nil, processedVideoUrl: String? = nil, analyticsData: AnyCodable? = nil) {
        self.id = id
        self.shop = shop
        self.video = video
