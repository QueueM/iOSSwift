...
public struct CustomersDetailsModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, name: String, phoneNumber: String? = nil, birthDate: Date? = nil, gender: CustomersDetailsModelGender? = nil, profilePhoto: String? = nil, customerType: CustomerTypeEnum? = nil, address: String? = nil, user: Int? = nil, preferredServices: [Int]? = nil) {
        self.id = id
        self.name = name
...
extension CustomersDetailsModel: Identifiable {}
